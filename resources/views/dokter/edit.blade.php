...
@section('content')
    ...
    <div class="card shadow-lg border-0 rounded-lg mt-5">
        <div class="card-header">
            <h3 class="text-center font-weight-light my-4">Edit Dokter</h3>
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('dokter.update',$data->id) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3 mb-md-0">
                            <input class="form-control @error('spesialis')is-invalid  @enderror"  value="{{$data->spesialis}}" id="spesialis"
                                name="spesialis" type="text" placeholder="Enter Sepsialis" />

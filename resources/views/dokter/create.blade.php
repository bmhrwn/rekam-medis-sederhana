...
@section('sub-title', 'Create Dokter')
...
@section('content')
    ...
    <div class="card shadow-lg border-0 rounded-lg mt-5">
        <div class="card-header">
            <h3 class="text-center font-weight-light my-4">Create Dokter</h3>
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('dokter.store') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3 mb-md-0">
                            <input class="form-control @error('spesialis')is-invalid  @enderror" id="spesialis"
